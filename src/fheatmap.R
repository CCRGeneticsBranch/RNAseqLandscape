...
# Graphics Settings
## Theme Blank
theme_blank <- function(){theme_blank<-theme(panel.grid.major = element_blank(), 
...
# #### Section 1  ####
  print(paste("Section 1 Start", Sys.time()))
  #Make new page
  grid.newpage()
  print(paste("Section 1 End", Sys.time()))
  
  # #### Section 2  ####
  print(paste("Section 2 Start", Sys.time()))  
  #Checking conditions
  ...
  print(paste("Section 2 End", Sys.time()))
  
  # #### Section 3  ####
  print(paste("Section 3 Start", Sys.time()))  
  ...
  print(paste("Section 3 End", Sys.time()))
    
  # #### Section 4  ####
  print(paste("Section 4 Start", Sys.time()))    
  #Setting Variables
  #Get col and row names
  col_names<- colnames(data)
  row_names<- rownames(data)
  print(paste("Section 4 End", Sys.time()))
  
  # #### Section 5  ####
  print(paste("Section 5 Start", Sys.time()))     
  ...
  max_row_annot_str <- c()
  max_col_annot_str <- c()
  print(paste("Section 5 End", Sys.time()))
  
  # #### Section 6  ####
  print(paste("Section 6 Start", Sys.time()))  
  #Determine Title Dimensions
  if (!is.na(title) ) { 
    title_height = convertHeight(unit(1, "grobheight", textGrob(title,gp = do.call(gpar,list(fontsize = title_fontsize/0.352777778)))), "npc",valueOnly = TRUE )+padding_h 
    } else { title_height = 0.01 }
  print(paste("Section 6 End", Sys.time()))  
  
  # #### Section 7  ####
  print(paste("Section 7 Start", Sys.time()))    
  #Set default Widths
  ...
  print(paste("Section 7 End", Sys.time()))  
  
  # #### Section 8  ####
  print(paste("Section 8 Start", Sys.time()))  
  ...
  print(paste("Section 8 End", Sys.time()))  
  
  # #### Section 9  ####
  print(paste("Section 9 Start", Sys.time()))    
  ...
  print(paste("Section 9 End", Sys.time()))  
  
  # #### Section 10  ####
  print(paste("Section 10 Start", Sys.time()))     
  ...
  print(paste("Section 10 End", Sys.time()))  
  
  # #### Section 11  ####
  print(paste("Section 11 Start", Sys.time()))     
  #ReSet Parameters
  #ReSet Legend width
  ...
  print(paste("Section 11 End", Sys.time()))  
  
  # #### Section 12  ####
  print(paste("Section 12 Start", Sys.time()))      
  #Make plot Grid
  ...
  print(paste("Section 12 End", Sys.time()))  
...
#   }}
  ...
  # #### Section 13  ####
  print(paste("Section 13 Start", Sys.time()))   
  ...
  print(paste("Section 13 End", Sys.time()))  
  
  
  # #### Section 14  ####
  print(paste("Section 14 Start", Sys.time()))    
  ##Draw annotations
  ...
  print(paste("Section 14 End", Sys.time()))  
  
  
  # #### Section 15  ####
  print(paste("Section 15 Start", Sys.time()))    
  #Draw matrix  
  ...
  print(paste("Section 15 End", Sys.time()))
  
  
  # #### Section 16  ####
  print(paste("Section 16 Start", Sys.time()))     
  #Draw names block
  if (display_colnames){
  ...
  print(paste("Section 16 End", Sys.time()))
